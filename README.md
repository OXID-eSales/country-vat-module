...
* b-4.x branch / v1.x is compatible with OXID eShop compilation > 4.9.x


## Installation 

```
copy files into modules/oxps/
```

After requiring the module, you need to activate it, e.g. via OXID eShop admin.


This module requires news tables in the database which will not(!) be created on module activation. You should execute this sql querys into your database: 
