    ...
    initAoc = function()
    {
        YAHOO.oxid.container1 = new YAHOO.oxid.aoc( 'container1',
            [ [{foreach from=$oxajax.container1 item=aItem key=iKey}]
                ...
                [{/foreach}] ],
            '[{$oViewConf->getAjaxLink()}]cmpid=container1&container=country_vat_article_main&synchoxid=[{$oxid}]'
        );
        ...
        YAHOO.oxid.container2 = new YAHOO.oxid.aoc( 'container2',
            [ [{foreach from=$oxajax.container2 item=aItem key=iKey}]
                ...
                [{assign var="sSep" value=","}]
                [{/foreach}] ],
            '[{$oViewConf->getAjaxLink()}]cmpid=container2&container=country_vat_article_main&oxid=[{$oxid}]'
        )
        ...
        YAHOO.oxid.container2.saveAttribute = function()
        {
            ...
            YAHOO.util.Connect.asyncRequest( 'GET', '[{$oViewConf->getAjaxLink()}]&cmpid=container2&container=country_vat_article_main&fnc=saveAttributeValue&oxid=[{$oxid}]&attr_value=' + encodeURIComponent( $('attr_value').value ) + '&attr_oxid=' + encodeURIComponent( $('attr_oxid').value ), callback );
